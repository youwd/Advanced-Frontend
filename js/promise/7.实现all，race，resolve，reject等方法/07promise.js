...
ywdPromise.all = function(promises) {
    return new ywdPromise(function(resolve, reject) {
        let result = [];
        let count = 0;
...
ywdPromise.race = function(promises) {
    return new ywdPromise(function(resolve, reject) {
        for (let i = 0; i < promises.length; i++) {
            promises[i].then(function(data) {
                resolve(data);
...
ywdPromise.resolve = function(value) {
    return new ywdPromise(resolve => {
        resolve(value);
    });
}

ywdPromise.reject = function(error) {
    return new ywdPromise((resolve, reject) => {
        reject(error);
    });
}
